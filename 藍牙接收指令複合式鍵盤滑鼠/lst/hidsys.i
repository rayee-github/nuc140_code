...
const uint8_t g_HID_sMSDesc[0x4c] =
{
    0x4C, 0x00, 0x00, 0x00,
    0x00, 0x01,
    0x05, 0x00,
    ...
    0x04, 0x00, 0x00, 0x00,
    0x30, 0x00,
    'S', 0, 'e', 0, 'l', 0, 'e', 0, 'c', 0, 't', 0, 'i', 0, 'v', 0, 'e', 0,
    'S', 0, 'u', 0, 's', 0, 'p', 0, 'e', 0, 'n', 0, 'd', 0, 
...
{   
    ...
    {0x20, 0x03, HID_CtrlSetupGetProtocol, 0, 0, &g_HID_sDevice},
	  ...
	  {0x40, 0x04,	MS_OS_CtrlSetup, 	HID_CtrlGetDescriptorIn, 	0, 	&g_HID_sDevice},	
};
...
void HID_CtrlSetupGetDescriptor(void * pVoid)
{
    ...
    case 0x22:
    {
        HID_PrepareDescriptors(g_HID_sDevice.pu8ReportDescriptor, g_HID_sDevice.u32ReportDescriptorSize, u16Len, 8);
        break;
    }
        ...
        else
        {
            ...
            case 3:
                ...
                break;
						...
						case 0xee: 
								HID_PrepareDescriptors((const uint8_t *)g_HID_sOSStringDesc, g_HID_sOSStringDesc[0], u16Len, 8);
								break;
...
void MS_OS_CtrlSetup(void * pVoid)
{
	S_HID_DEVICE *psDevice = (S_HID_DEVICE *) pVoid;
	S_DRVUSB_DEVICE *pUsbDevice = (S_DRVUSB_DEVICE *)psDevice->device;
	uint16_t u16Len;
	...
	HID_PrepareDescriptors((const uint8_t *)g_HID_sMSDesc, sizeof(g_HID_sMSDesc), u16Len, 8);
