...
void InitCapture(void)
{
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.PWM0_AD13=1;			
	 		
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.PWM01_EN = 1;
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.PWM01_S = 0;

	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PPR.CP01=11;			
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CSR.CSR0=4;			
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CAPCH0EN=1;		

	 
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CRL_IE0=1;		
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CFL_IE0=1;		
...
void InitPWM1(void)
{
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.PWM1_AD14=1;
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PPR.CP01=11;			
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CSR.CSR1=3;			
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1=0x3FFF;
...
void InitPWM2(void)
{
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPAMFP.PWM2_AD15=1;
	...
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CSR.CSR2=4;			
				         
	 
	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PCR.CH2MOD=1;			
								
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR2=0x1FFF;
	((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR2=0x0FFF;
...
{
	if(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PIIR.PWMIF0)
	{
		CaptureCounter++;
		if(CaptureCounter==0)
		{
		...
		((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PIIR.PWMIF0=1;
	}
	if(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CAPIF0)
	{
		if(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CFLRI0)
		{
			CaptureValue[0]=CaptureCounter*(0xFFFF+1)+(0xFFFF-((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CFLR0);
			CaptureCounter=0;
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CFLRI0=0;
		}
		if(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CRLRI0)
		{
			CaptureValue[1]=CaptureCounter*(0xFFFF+1)+(0xFFFF-((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CRLR0);
			CaptureCounter=0;
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CRLRI0=0;	
		}
		((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0.CAPIF0=1;
	}
}
...
int32_t main (void)
{
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x59;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x16;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x88;
	...
	Delay(200);
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0.HCLK_S = 4;
