...
#line 175 "Smpl_HID_FILE_IO.c"

#line 283 "Smpl_HID_FILE_IO.c"
...
void HID_SetInReport()
{
    ...
    if((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040))->PIN & (1 << 15)) == 0)
    {
...
int32_t HID_MainProcess(void)
{
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040))->IEN = (1 << 15);
