...
while(1);
	...
	{
		printf("Deep Sleep\n");
		while(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR.TE_FLAG == 0);
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->DOUT|=0x7000;
		*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x59;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x16;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x88;						  
		((SCB_Type *) ((0xE000E000) + 0x0D00))->SCR = 4;
		((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON.PD_WU_INT_EN= 0;	
       ...
       while((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040))->PIN &= 0x8000)==0)
	   {
			((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->DOUT&=0x8FFF;
			Delay(30000);
			((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->DOUT|=0x7000;
			Delay(30000);
	   }
