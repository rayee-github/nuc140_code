...
int main (void)
{
	...
	uint8_t	test1,test2;
	int ud,rl;
	float ax,ay,az,gx,gy,gz,hx=0,hy=0,hz=0;
	float temp;
	float Xh,Yh	;
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	while(1){
		...
		sprintf(textout,"x%dy%dz%da%db%dc%dq%dw%de%dd",(int)(ax*100),(int)(ay*100),(int)(az*100),(int)gx,(int)gy,(int)gz,(int)hx,(int)hy,(int)hz);
