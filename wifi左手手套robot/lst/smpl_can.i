...
{
	DrvADC_Open(ADC_SINGLE_END,ADC_SINGLE_CYCLE_OP,0x17,EXTERNAL_12MHZ,0x9);   
	DrvSYS_Delay(100); 
}
...
{  
	...
	for (ii = 0; ii < packet_count; ii++) {
		...
		data[0]=readByte(0x68,0x3B); 
		data[1]=readByte(0x68,0x3C);
		data[2]=readByte(0x68,0x3D);
		data[3]=readByte(0x68,0x3E);
		data[4]=readByte(0x68,0x3F);
		data[5]=readByte(0x68,0x40);
		data[6]=readByte(0x68,0x43);
		data[7]=readByte(0x68,0x44);
		data[8]=readByte(0x68,0x45);
		data[9]=readByte(0x68,0x46);
		data[10]=readByte(0x68,0x47);
		data[11]=readByte(0x68,0x48);
...
int main (void)
{
  ...
  delay_time(10);	
	...
	while(1)
	{
		...
		ax = accelCount[0]*2.0/32768.0- accelBias[0];	  
		...
		if(ax>=0.4f)      
		{
			...
			{
				case 1:
					c1=0x11;c2=0x01;break;
				case 2:
					c1=0x12;c2=0x02;break;
				case 3:
					c1=0x13;c2=0x03;break;
				case 4:
					c1=0x14;c2=0x04;break;
				case 5:
					c1=0x15;c2=0x05;break;
				case 6:
					c1=0x16;c2=0x06;break;
				case 7:
					c1=0x17;c2=0x07;break;
			}
		}
		else if(ax<=-0.4f)    
		{
			...
			{
				case 1:
					c1=0x01;c2=0x11;break;
				case 2:
					c1=0x02;c2=0x12;break;
				case 3:
					c1=0x03;c2=0x13;break;
				case 4:
					c1=0x04;c2=0x14;break;
				case 5:
					c1=0x05;c2=0x15;break;
				case 6:
					c1=0x06;c2=0x16;break;
				case 7:
					c1=0x07;c2=0x17;break;
			}
		}
		else if(ay>=0.4f)       
		{
			command2=((int)(ay*10))-3;
			if(command2>7)
				command2=7;
			...
			{
				case 1:
					c1=0x01;c2=0x01;break;
				case 2:
					c1=0x02;c2=0x02;break;
				case 3:
					c1=0x03;c2=0x03;break;
				case 4:
					c1=0x04;c2=0x04;break;
				case 5:
					c1=0x05;c2=0x05;break;
				case 6:
					c1=0x06;c2=0x06;break;
				case 7:
					c1=0x07;c2=0x07;break;
			}
		}	
		else if(ay<=-0.4f)		
		{
			...
			{
				case 1:
					c1=0x11;c2=0x11;break;
				case 2:
					c1=0x12;c2=0x12;break;
				case 3:
					c1=0x13;c2=0x13;break;
				case 4:
					c1=0x14;c2=0x14;break;
				case 5:
					c1=0x15;c2=0x15;break;
				case 6:
					c1=0x16;c2=0x16;break;
				case 7:
					c1=0x17;c2=0x17;break;
			}
		}
		else 
		{
		...
		if(adc1>1500 || adc2>1500 || adc3>1500 || adc4>1500)
		{
			DrvGPIO_ClrBit(E_GPC, 2);
		...
		if(DrvGPIO_GetBit(E_GPC, 8)==0)
		{
			...
			DrvSYS_Delay(100000);
			sprintf(textout,"%c%c%c",c1,c2,c3);	
