...
void I2C0_IRQHandler(void)
{
    ...
    status  = ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS;

    if (((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CTOC.TIF)
    {
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CTOC.TIF = 1;   
...
void I2C1_IRQHandler(void)
{
    ...
    status  = ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CSTATUS;

    if (((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CTOC.TIF)
    {
        ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CTOC.TIF = 1;   
...
void DrvI2C_Ctrl(E_I2C_PORT port, uint8_t start, uint8_t stop, uint8_t intFlag, uint8_t ack)
{
    ...
    if (port)
        *((volatile uint32_t *)&((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON) = (*((volatile uint32_t *)&((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON) & ~0x3C) | Reg;
    else
        *((volatile uint32_t *)&((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON) = (*((volatile uint32_t *)&((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON) & ~0x3C) | Reg;
}
...
uint8_t DrvI2C_ReadData(E_I2C_PORT port)
{
    if (port)
    {                          
        return ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT;
    }   
    else
    {
        return ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT;  
    }
}
...
uint8_t DrvI2C_GetIntFlag(E_I2C_PORT port)
{
    if (port)
    {
        return ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI;
    }   
    else
    {
        return ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON.SI;    
    }
}
...
void DrvI2C_ClearIntFlag(E_I2C_PORT port)
{
    if (port)
    { 
        ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI = 1;
    }   
    else
    {
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON.SI = 1;   
    }           
}
...
uint32_t DrvI2C_GetStatus(E_I2C_PORT port)
{
    if (port)
    {
        return ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CSTATUS;
    }
    else
    {
        return ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS;
    }   
}
...
int32_t DrvI2C_Open(E_I2C_PORT port, uint32_t u32BusClock)
{
    ...
    if (port)
    {
        ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.I2C1_EN = 1;
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C1_RST = 1;
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C1_RST = 0;
        ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.ENS1 = 1;
        ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CLK = divider;
    }
    else
    {
        ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.I2C0_EN = 1;
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C0_RST = 1;
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C0_RST = 0;  
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON.ENS1 = 1;
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CLK = divider;
    }
...
int32_t DrvI2C_Close(E_I2C_PORT port)
{
    if (port)
    {
        ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.ENS1 = 0;
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C1_RST = 1;
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C1_RST = 0;
        ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.I2C1_EN = 0;
    }
    else
    {
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON.ENS1 = 0;
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C0_RST = 1;
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.I2C0_RST = 0;
        ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.I2C0_EN = 0;
    }
...
uint32_t DrvI2C_GetClockFreq(E_I2C_PORT port)
{
    ...
    divider = ( (port)? ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CLK:((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CLK );
...
int32_t DrvI2C_EnableInt(E_I2C_PORT port)
{
    if (port)
    {
        ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.EI = 1;
        NVIC_SetPriority(I2C1_IRQn, (1<<2) - 2);
        NVIC_EnableIRQ(I2C1_IRQn);
    }
    else
    {
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON.EI = 1;
        NVIC_SetPriority(I2C0_IRQn, (1<<2) - 2);
...
int32_t DrvI2C_DisableInt(E_I2C_PORT port)
{
    if (port)
    {
        ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.EI = 0;
        NVIC_DisableIRQ(I2C1_IRQn);
    }
    else
    {
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CON.EI = 0;
...
int32_t DrvI2C_SetTimeoutCounter(E_I2C_PORT port, int32_t i32enable, uint8_t u8div4)
{
    if (port)
    {
        ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CTOC.DIV4 = u8div4;
        ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CTOC.ENTI = i32enable;
    }
    else
    {
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CTOC.DIV4 = u8div4;
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CTOC.ENTI = i32enable;
    }
    return 0;
}
...
int32_t DrvI2C_SetAddress(E_I2C_PORT port, uint8_t slaveNo, uint8_t slave_addr, uint8_t GC_Flag)
{
    if (port)
    {
        ...
        {
            case 0:
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADDR0.I2CADDR = slave_addr;
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADDR0.GC      = GC_Flag;
                break;
            case 1:
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADDR1.I2CADDR = slave_addr;
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADDR1.GC      = GC_Flag;
                break;
            case 2:
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADDR2.I2CADDR = slave_addr;
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADDR2.GC      = GC_Flag;
                break;
            case 3:
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADDR3.I2CADDR = slave_addr;
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADDR3.GC      = GC_Flag;
                break;
            default:
                return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2C) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
        }
    }
    else
    {
        ...
        {
            case 0:
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADDR0.I2CADDR  = slave_addr;
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADDR0.GC       = GC_Flag;
                break;
            case 1:
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADDR1.I2CADDR = slave_addr;
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADDR1.GC      = GC_Flag;
                break;
            case 2:
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADDR2.I2CADDR = slave_addr;
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADDR2.GC      = GC_Flag;
                break;
            case 3:
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADDR3.I2CADDR = slave_addr;
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADDR3.GC      = GC_Flag;
                break;
            default:
                return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2C) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
        }
...
int32_t DrvI2C_SetAddressMask(E_I2C_PORT port, uint8_t slaveNo, uint8_t slaveAddrMask)
{
    ...
    if (port)
    {
        ...
        {
            case 0:
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADM0.I2CADM = slaveAddrMask;
                break;
            case 1:
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADM1.I2CADM = slaveAddrMask;
                break;
            case 2:
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADM2.I2CADM = slaveAddrMask;
                break;
            case 3:
                ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CADM3.I2CADM = slaveAddrMask;
                break;
            default:
                return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2C) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
        }
    ...
    else
    {
        ...
        {
            case 0:
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADM0.I2CADM = slaveAddrMask;
                break;
            case 1:
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADM1.I2CADM = slaveAddrMask;
                break;
            case 2:
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADM2.I2CADM = slaveAddrMask;
                break;
            case 3:
                ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CADM3.I2CADM = slaveAddrMask;
                break;
            default:
                return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVI2C) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
        }   
