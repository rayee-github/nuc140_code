...
#line 7 "..\\..\\..\\Src\\Driver\\DrvCAN.c"

 
 
 
#line 1 "..\\..\\..\\Include\\Driver\\DrvCAN.h"
...
#line 11 "..\\..\\..\\Include\\Driver\\DrvCAN.h"
...
#line 41 "..\\..\\..\\Include\\Driver\\DrvCAN.h"
...
#line 115 "..\\..\\..\\Include\\Driver\\DrvCAN.h"

 
#line 123 "..\\..\\..\\Include\\Driver\\DrvCAN.h"

 
#line 131 "..\\..\\..\\Include\\Driver\\DrvCAN.h"

 


 
#line 144 "..\\..\\..\\Include\\Driver\\DrvCAN.h"
...
#line 164 "..\\..\\..\\Include\\Driver\\DrvCAN.h"


 
#line 175 "..\\..\\..\\Include\\Driver\\DrvCAN.h"
...
#line 13 "..\\..\\..\\Src\\Driver\\DrvCAN.c"
#line 14 "..\\..\\..\\Src\\Driver\\DrvCAN.c"
...
void CAN0_IRQHandler(void)
{
    ...
    if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32IIDR == 0x8000)     	   
	{
		 
		 
		 
		
        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.RXOK == 1)
        {
            ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.RXOK = 0;     
        ...
        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.TXOK == 1)
		{
            ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.TXOK = 0;     
        ...
        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.EWARN==1)
        {
             ; 
        ...
        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.BOFF==1)
        {
             ; 
	...
	else if ((((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32IIDR)!=0)
	{                       
        ;

		u8IIDRstatus = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32IIDR;
		...
		DrvCAN_ClrIntPnd((((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32IIDR) -1 );	    

	}

    else if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32WU_STATUS==1)
    {
        ;

        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32WU_STATUS = 0;     				    
...
static uint32_t GetFreeIF(void)
{
    if (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].CREQ.BUSY == 0)
        return 0;
    else if (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].CREQ.BUSY == 0)
        return 1;
    else
   	    return 2;
}
...
int32_t DrvCAN_GetCANBitRate(void)
{
    ...
    u8Tseg1 = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.TSEG1;
    u8Tseg2 = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.TSEG2;
    u32Bpr  = (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.BRP) | (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BRPE.BPRE <<6);
...
void DrvCAN_Init(void)
{
    ...
    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.CAN0_EN  =1;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.CAN0_RST   =1;  
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.CAN0_RST   =0;
}
...
void DrvCAN_Close(void)
{
    ...
    CANHandler.WakeupCallBackFn             = 0;    
 	...
 	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.CAN0_RST   =1;  
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2.CAN0_RST   =0;  
    ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.CAN0_EN  =0;
...
int32_t DrvCAN_Open(uint32_t u32kbps)
{
    ...
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.TSEG1 = u8Tseg1;  
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.TSEG2 = u8Tseg2;  
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.BRP   = u32Bpr & 0x3F ;  
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32BRPE     = (u32Bpr >> 6) & 0x0F;
    
     
    if ((u32kbps < (DrvCAN_GetCANBitRate()*95/100)) || (u32kbps > (DrvCAN_GetCANBitRate()*105/100)))
    {
        ;
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVCAN) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((4) & 0x7F));        
    }
...
void DrvCAN_SetTiming(uint8_t u8Tseg2, uint8_t u8Tseg1, uint8_t u8Sjw, uint32_t u32Brp)
{
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.TSEG1 = u8Tseg1;  
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.TSEG2 = u8Tseg2;  
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.SJW   = u8Sjw;  
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->BTIME.BRP   = u32Brp & 0x3F ;  
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32BRPE     = (u32Brp >> 6) & 0x0F;
}
...
int32_t DrvCAN_ResetMsgObj(uint8_t u8MsgObj)
{
    ...
    {
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVCAN) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((6) & 0x7F));
    }

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32CMASK  = 0xF3;  
 
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32MASK1  = 0;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32MASK2  = 0;

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB1   = 0;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB2   = 0;

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32MCON   = 0;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32DAT_A1 = 0;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32DAT_A2 = 0;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32DAT_B1 = 0;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32DAT_B2 = 0;

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32CREQ   = 1 + u8MsgObj;
...
int32_t DrvCAN_SetTxMsgObj(uint8_t u8MsgObj, STR_CANMSG_T* pCanMsg)
{
    ...
    if (pCanMsg->IdType == CAN_STD_ID)
    {
        ...
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB1 = 0;
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB2 =  (((pCanMsg->Id)&0x7FF)<<2) | 0x2000 | 0x8000; 
    }
    else
    {
         
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB1 = (pCanMsg->Id)&0xFFFF;
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB2 = ((pCanMsg->Id)&0x1FF0000)>>16 | 0x2000 | 0x4000 | 0x8000;
    }

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].ARB2.DIR =pCanMsg->FrameType?1:0;

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32DAT_A1 = ((uint16_t)pCanMsg->Data[1]<<8) | pCanMsg->Data[0];
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32DAT_A2 = ((uint16_t)pCanMsg->Data[3]<<8) | pCanMsg->Data[2];
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32DAT_B1 = ((uint16_t)pCanMsg->Data[5]<<8) | pCanMsg->Data[4];
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32DAT_B2 = ((uint16_t)pCanMsg->Data[7]<<8) | pCanMsg->Data[6];

	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32MCON   =  0x8000 | pCanMsg->DLC |0x0800 | 0x0080;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32CREQ   = 1 + u8MsgObj;
...
int32_t DrvCAN_SetMsgObjMask(uint8_t u8MsgObj,STR_CANMASK_T* MaskMsg)
{
    ...
    {
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32MASK1 =  0;
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32MASK2 =  ((MaskMsg->u32Id&0x7FF)<<2) ; 
    }
    else										     
    {
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32MASK1 = (MaskMsg->u32Id) &0xFFFF;
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32MASK2 = ((MaskMsg->u32Id)&0x1FF0000)>>16 ;
    }

	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].MASK2.MXTD = MaskMsg->u8Xtd;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].MASK2.MDIR = MaskMsg->u8Dir;
    
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].MCON.UMASK = 1;

	 
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32CMASK = 0x0080| 0x0040;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32CREQ  = 1 + u8MsgObj;
...
int32_t DrvCAN_SetRxMsgObj(uint8_t u8MsgObj, uint8_t u8idType, uint32_t u32id, uint8_t u8singleOrFifoLast)
{
    ...
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32CMASK = 0x0080| 0x0040 | 0x0020 | 
	                             0x0010 | 0x0002  | 0x0001;

    if (u8idType == CAN_STD_ID)  
    {
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB1   = 0;
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB2   = 0x8000 | (u32id & 0x7FF)<< 2;
    }
    else
    {
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB1   = u32id & 0xFFFF;
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32ARB2   = 0x8000 | 0x4000 | (u32id & 0x1FF0000)>>16;
    }

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].MCON.UMASK = 1;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].MCON.RXIE  = 1;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].MCON.EOB   = u8singleOrFifoLast?1:0;
...
int32_t DrvCAN_ClrIntPnd(uint8_t u8MsgObj)
{
    ...
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32CMASK = 0x0008 | 0x0004;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8MsgIfNum].u32CREQ = 1 + u8MsgObj;
...
{
    STR_CANMSG_T rMsg; 
    DrvCAN_ReadMsgObj(u8MsgObj,1, &rMsg);
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32CMASK  = 0x0080 |0x0004 ;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32CREQ  = 1 + u8MsgObj;
    return 0;
}
...
int32_t DrvCAN_ReadMsgObj(uint8_t u8MsgObj, uint8_t u8Release, STR_CANMSG_T* pCanMsg)
{
    ...
    {
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVCAN) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((5) & 0x7F));
    }

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.RXOK =0;

     
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].u32CMASK = 0x0040
                          | 0x0020
                          | 0x0010
                          | 0x0008
                          | (u8Release ? 0x0004 : 0)
    ...
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].u32CREQ = 1 + u8MsgObj;

    if (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].CREQ.BUSY ==1)
    {
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVCAN) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((6) & 0x7F));
    }

    if ((((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].ARB2.XTD) == 0)
    {
         
        pCanMsg->IdType = CAN_STD_ID;
        pCanMsg->Id     = (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].ARB2.ID28_16 >> 2);
    }
    else
    {
         
        pCanMsg->IdType = CAN_EXT_ID;
        pCanMsg->Id  = (((((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].u32ARB2) & 0x1FFF)<<16) | ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].u32ARB1; 
    }
    
    pCanMsg->DLC     = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].MCON.DLC;
    pCanMsg->Data[0] = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].DAT_A1.DATA0;
    pCanMsg->Data[1] = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].DAT_A1.DATA1;
    pCanMsg->Data[2] = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].DAT_A2.DATA2;
    pCanMsg->Data[3] = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].DAT_A2.DATA3;
    pCanMsg->Data[4] = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].DAT_B1.DATA4;
    pCanMsg->Data[5] = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].DAT_B1.DATA5;
    pCanMsg->Data[6] = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].DAT_B2.DATA6;
    pCanMsg->Data[7] = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].DAT_B2.DATA7;
...
int32_t DrvCAN_WaitEndOfTx(void)
{
    while(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.TXOK==0);
    return 0;
}
...
{
    uint32_t i=0;
    while(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].CREQ.BUSY==1);
   
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.TXOK = 0;

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32CMASK = 0x0080;  

    if (pCanMsg->IdType == CAN_STD_ID)
    {
         
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32ARB1 = 0;
		((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32ARB2 =  (((pCanMsg->Id)&0x7FF)<<2) ;
    }
    else
    {
         
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32ARB1 = (pCanMsg->Id)&0xFFFF;
        ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32ARB2 = ((pCanMsg->Id)&0x1FFF0000)>>16  | 0x4000;

    }
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].ARB2.DIR = (pCanMsg->FrameType)?1:0;

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].MCON.DLC = pCanMsg->DLC ;

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32DAT_A1 = ((uint16_t)pCanMsg->Data[1]<<8) | pCanMsg->Data[0];
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32DAT_A2 = ((uint16_t)pCanMsg->Data[3]<<8) | pCanMsg->Data[2];
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32DAT_B1 = ((uint16_t)pCanMsg->Data[5]<<8) | pCanMsg->Data[4];
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].u32DAT_B2 = ((uint16_t)pCanMsg->Data[7]<<8) | pCanMsg->Data[6];

     
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].CREQ.BUSY = 0;
	if ( ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].CREQ.BUSY ==1 ) {
		;
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVCAN) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
	}
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].CREQ.BUSY =1;						   

    for ( i=0; i<0xFFFFF; i++) {
		if ( ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[0].CREQ.BUSY ==0) break;
	}
...
int32_t DrvCAN_BasicReceiveMsg(STR_CANMSG_T* pCanMsg)
{
    if (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].MCON.NEWDAT == 0)  
    {
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVCAN) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((5) & 0x7F));
    }
    ...
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].u32CMASK = 0x0020
                             | 0x0010
                             | 0x0002
                             | 0x0001;
    ...
    if (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].ARB2.XTD == 0)
    {
        ...
        pCanMsg->IdType = CAN_STD_ID;
        pCanMsg->Id = (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].u32ARB2 >> 2) & 0x07FF;
    ...
    else
    {
        ...
        pCanMsg->IdType = CAN_EXT_ID;
        pCanMsg->Id  = (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].u32ARB2 & 0x1FFF)<<16;
        pCanMsg->Id |= (uint32_t)((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].u32ARB1;
    }

    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].ARB2.DIR = pCanMsg->FrameType?0:1;
...
void DrvCAN_EnterInitMode(void)
{
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CON.INIT = 1;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CON.CCE  = 1;
}
...
void DrvCAN_LeaveInitMode(void)
{
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CON.INIT = 0;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CON.CCE  = 0;
   	while ( ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CON.INIT==1);        
}
...
{
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CON.TEST = 1;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32TEST = u8TestMask;
}
...
{
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CON.TEST = 1;
  	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32TEST &= ~(0x0010 | 0x0008 | 0x0004);
  	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->CON.TEST = 0;
}
...
{
    return (u8MsgObj < 16 ? ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32NDAT1 & (1 << u8MsgObj) : ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32NDAT2 & (1 << (u8MsgObj-16)));
}
...
{
  	return (u8MsgObj < 16 ? ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32TXREQ1 & (1 << u8MsgObj) : ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32TXREQ2 & (1 << (u8MsgObj-16)));
}
...
uint32_t DrvCAN_IsIntPending(uint8_t u8MsgObj)
{
  	return (u8MsgObj < 16 ? ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32IPND1 & (1 << u8MsgObj) : ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32IPND2 & (1 << (u8MsgObj-16)));
}
...
{
  	return (u8MsgObj < 16 ? ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32MVLD1 & (1 << u8MsgObj) : ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32MVLD2 & (1 << (u8MsgObj-16)));
}
...
void DrvCAN_ResetIF(uint8_t u8IF_Num)
{
	if(u8IF_Num > 1)
        return;
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32CREQ     = 0x0;			
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32CMASK    = 0x0;
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32MASK1    = 0x0;			
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32MASK2    = 0x0;		    
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32ARB1     = 0x0;		    
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32ARB2     = 0x0;		    
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32MCON     = 0x0;  	    	
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32DAT_A1   = 0x0;			
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32DAT_A2   = 0x0;			
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32DAT_B1   = 0x0;			
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[u8IF_Num].u32DAT_B2   = 0x0;			
}
...
void DrvCAN_WaitMsg(void)
{
	((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32STATUS = 0x0;			 

	while (1) 
	{
		if ( ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->sMsgObj[1].MCON.NEWDAT == 1 )   
		{
			;
			break;	
		}
		...
		if ( ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS.LEC)
		{
			;
		}
	}
...
int32_t DrvCAN_EnableInt(uint16_t u16IntEnable)
{
    ...
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32CON = (((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32CON & 0xF1) | ((u16IntEnable & 0x0002   )? 0x0002 :0)
                                       | ((u16IntEnable & 0x0004  )? 0x0004:0)
                                       | ((u16IntEnable & 0x0008  )? 0x0008:0);

    NVIC_SetPriority(CAN0_IRQn, (1<<2) - 2);
...
int32_t DrvCAN_DisableInt(uint16_t u16IntEnable)
{
    ...
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32CON = ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32CON & ~(0x0002 | ((u16IntEnable & 0x0004 )?0x0004:0)
                                    | ((u16IntEnable & 0x0008 )?0x0008:0));
...
int32_t DrvCAN_InstallCallback(E_CAN_CALLBACK_TYPE Type, CAN_CALLBACK callbackfn)
{
    switch(Type)
    {
        ...
        case CALLBACK_WAKEUP:   
                                ...
                                break;
        default:
            return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVCAN) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((3) & 0x7F));                               
    }
...
void DrvCAN_EnableWakeUp(void)
{
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32WU_EN = 1;
}
...
void DrvCAN_DisableWakeUp(void)
{
    ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->u32WU_EN = 0;
}
...
uint32_t DrvCAN_GetRxErrCount(void)
{
    return ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->ERR.REC;
}
