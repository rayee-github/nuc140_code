...
{
	DrvADC_Open(ADC_SINGLE_END,ADC_SINGLE_CYCLE_OP,0xE0,EXTERNAL_12MHZ,0x9);   
	Delay (100); 
}
...
int32_t main (void)
{
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	while(1)
	{
		...
		Show_Word(0,12,' ');
		Show_Word(0,13,' ');
		sprintf(adc_value1,"A%d\r",(adc1-2900)*8);                    
