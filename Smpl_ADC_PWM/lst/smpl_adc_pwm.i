...
void InitPWM(void)
{
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.PWM01_S = 3;
...
int32_t main (void)
{
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	while(1)
	{
		while(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADSR.ADF==0);
		((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADSR.ADF=1;
		Show_Word(0,11,' ');
		Show_Word(0,12,' ');
		Show_Word(0,13,' ');
		sprintf(adc_value+10,"%d",((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[7].RSLT);
