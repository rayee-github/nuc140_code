...
void InitWDT(void)
{
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x59;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x16;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x88;		
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.WDT_S =3;
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.WDT_EN =1;

	 
	((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR.WTIS=5;
...
{
	*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TLR))=a<<20|b<<16|c<<12|d<<8|e<<4|f	 ;
}
void set_CLR (int32_t a,int32_t b,int32_t c,int32_t d,int32_t e,int32_t f)
{
	*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->CLR))=a<<20|b<<16|c<<12|d<<8|e<<4|f	 ;
}
void set_TAR(int32_t a,int32_t b,int32_t c,int32_t d,int32_t e,int32_t f)
{
	*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TAR))=a<<20|b<<16|c<<12|d<<8|e<<4|f	;
}
void set_CAR (int32_t a,int32_t b,int32_t c,int32_t d,int32_t e,int32_t f)
{
	*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->CAR))=a<<20|b<<16|c<<12|d<<8|e<<4|f	;
}
void START_RTC(void)
{
  	...
  	while(1)
  	{
		...
		if((*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->INIR)))==1)
        	break; 
  	}   
  	while(1)
  	{
  		((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->AER.AER = 0xA965;
    	if((*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->AER)))&0x10000)
        	break;  
    }
}
void InitRTC(void)
{
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x59;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x16;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x88;		
	...
	((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TSSR.HR24_HR12     =1;
...
void RTC_IRQHandler(void)
{
	...
	if((*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->RIIR)))&0x2)
 	{
		clock=(*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TLR)))&0xFFFFFF;
		...
		*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->RIIR))=2;
	}
	 
	if((*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->RIIR)))&0x1) 
	{
		print_lcd(1, "Alarm!!!!");
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->DOUT&=0xFF;
		Alarm_E=0;
		*((volatile unsigned int *)(&((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->RIIR))=1;
	}
}
...
void InitTIMER0(void)
{
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCMPR = 2765;		
