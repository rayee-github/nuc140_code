...
#line 12 "Smpl_UART0.c"
#line 13 "Smpl_UART0.c"
...
int32_t main()
{
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	while(1)
	{
		DrvUART_Write(UART_PORT0,"AT+CIPSEND=0,5\r\n",16); 
			DrvSYS_Delay(300000);
		DrvUART_Write(UART_PORT0,"a1111",5); 
			DrvSYS_Delay(300000);; 	  
		DrvUART_Write(UART_PORT0,"AT+CIPSEND=1,5\r\n",16); 
			DrvSYS_Delay(300000);
		DrvUART_Write(UART_PORT0,"b1111",5); 
			DrvSYS_Delay(300000);
		DrvUART_Write(UART_PORT0,"AT+CIPSEND=0,5\r\n",16); 
			DrvSYS_Delay(300000);
		DrvUART_Write(UART_PORT0,"a2222",5); 
			DrvSYS_Delay(300000);
		DrvUART_Write(UART_PORT0,"AT+CIPSEND=1,5\r\n",16); 
			DrvSYS_Delay(300000);
		DrvUART_Write(UART_PORT0,"b2222",5); 
			DrvSYS_Delay(300000);	 
