  ...
  delay_time(5);	
	...
	//while(1)
	{
		...
		while(1){
			...
			yaw = atan2(Yh,Xh)/2;
			adc1=(get_ADC_value(4)-2500)*6;           //
			if(adc1<0)
				adc1=3000;
			//adc2=(get_ADC_value(3)-2500)*8;
			//adc3=(get_ADC_value(2)-2500)*8;
			//校正
			/*		if(hx>maxx)
			maxx=hx;
			if(hx<minx)
		...
		/*	else if(adc2<2000)
			...
			if(adc1>=2000 && adc2>=2000 && adc3>=2000 && roll<0.7 && roll>-0.7 && pitch<0.5 && pitch>-0.5)
			{
				rl=0;
				ud=0;
			}	
			...
			DrvSYS_Delay(10000);; 	  
			/*sprintf(textout," %d -%d ",adc1,get_ADC_value(4));	                 //此兩行刪掉
			DrvUART_Write(UART_PORT0,textout,20);*/
			///////////////////////////////////////////
