#line 1 "..\\..\\..\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 7 "..\\..\\..\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 8 "..\\..\\..\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 9 "..\\..\\..\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 10 "..\\..\\..\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
#line 11 "..\\..\\..\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
#line 1 "..\\..\\..\\Include\\NUC1xx-LB_002\\EEPROM_24LC64.h"


     
extern void Write_24LC64(uint32_t address,uint8_t data);
extern uint8_t Read_24LC64(uint32_t address);
#line 12 "..\\..\\..\\Src\\NUC1xx-LB_002\\EEPROM_24LC64.c"
...
void Write_24LC64(uint32_t address,uint8_t data )
{
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = 0XA0;					
    DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0); 
    while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0 );		    
	
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = (address>>8)&0XFF;	
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 1); 
	while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0 );			
	
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = address&0XFF;	
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 1); 
	while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0 );			
...
uint8_t Read_24LC64(uint32_t address)
{
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = 0XA1;
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 1);    
    while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0 );			   
	...
	DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0);    
	while( ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON.SI == 0 );			   
	TEMP= ((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT;
