...
{   //request type,command     ,setup ack handler         , in ack handler      ,out ack handler,  parameter
    ...
    {REQ_CLASS, GET_PROTOCOL, HID_CtrlSetupGetProtocol, 0, 0, &g_HID_sDevice},
		/* Vendor Command */
	  {REQ_VENDOR, 0x04,	MS_OS_CtrlSetup, 	HID_CtrlGetDescriptorIn, 	0, 	&g_HID_sDevice},	// MS OS for Selective Suspend
};
        ...
        else
        {
            ...
            case 3:
                ...
                break;
						...
						case 0xee: // MS OS Descriptor
								HID_PrepareDescriptors((const uint8_t *)g_HID_sOSStringDesc, g_HID_sOSStringDesc[0], u16Len, HID_MAX_PACKET_SIZE_CTRL);
								break;
...
void MS_OS_CtrlSetup(void * pVoid)
{
	...
	HID_PrepareDescriptors((const uint8_t *)g_HID_sMSDesc, sizeof(g_HID_sMSDesc), u16Len, HID_MAX_PACKET_SIZE_CTRL);
