...
void HID_SetInReport()
{
 ...
 uint8_t *buf;
    ...
    key = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->PIN & (1 << 2))? 0 : 1;
		
		 
    key1 = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->PIN & (1 << 3))? 0 : 1;
		
		 
    key2 = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->PIN & (1 << 4))? 0 : 1;
    ...
    if ((key | key1 | key2) == 0)
    {
        ...
        {																																					                                                                                                             
            ...
            DrvUSB_DataIn(0x01, g_HID_sDevice.pu8Report, g_HID_sDevice.u32ReportSize);
        }
		}
		else if (key == 1)
    {	
