...
typedef struct
{
    ...
    const uint8_t *pu8ReportDescriptor_MS;
    uint32_t u32ReportDescriptorSize_MS;
	
		const uint8_t *pu8ReportDescriptor_KB;
    uint32_t u32ReportDescriptorSize_KB;

    const uint8_t *pu8HIDDescriptor;

    uint8_t *pu8Report_MS, *pu8Report_KB;
    uint32_t u32ReportSize_MS, u32ReportSize_KB;
    int8_t isReportReady_MS, isReportReady_KB;
...
void HID_Close(void);
void HID_IntInCallback_MS(void * pVoid);
void HID_IntInCallback_KB(void * pVoid);
int32_t HID_SetReportDescriptor_MS(const uint8_t * pu8ReportDescriptor, uint32_t u32ReportDescriptorSize);
int32_t HID_SetReportBuf_MS(uint8_t * pu8Report, uint32_t u32ReportSize);
int32_t HID_SetReportDescriptor_KB(const uint8_t * pu8ReportDescriptor, uint32_t u32ReportDescriptorSize);
int32_t HID_SetReportBuf_KB(uint8_t * pu8Report, uint32_t u32ReportSize);
...
S_DRVUSB_EVENT_PROCESS g_sBusOps[6] = 
{
    ...
    {DrvUSB_BusSuspendCallback, &g_HID_sDevice}, 
    {DrvUSB_BusResumeCallback, &g_HID_sDevice},  
...
S_DRVUSB_EVENT_PROCESS g_sUsbOps[12] = 
{
    ...
    {HID_IntInCallback_MS   , &g_HID_sDevice}, 
    {0, 0},                              
    {HID_IntInCallback_KB		, &g_HID_sDevice},   
    {0, 0},                                
    {0, 0},                                
    {0, 0},                                
    {0, 0},                                
...
{   
    ...
    {0x00, 0x06, HID_CtrlSetupGetDescriptor, HID_CtrlGetDescriptorIn, 0 , &g_HID_sDevice},
    {0x00, 0x09, DrvUSB_CtrlSetupSetConfiguration, 0, 0, &g_HID_sDevice},
     
    {0x20, 0x09, HID_CtrlSetupSetReport, 0, HID_CtrlSetupDataOutReport, &g_HID_sDevice},
    {0x20, 0x0A, HID_CtrlSetupSetIdle, 0, 0, &g_HID_sDevice},
    {0x20, 0x0B, HID_CtrlSetupSetProtocol, 0, 0, &g_HID_sDevice},
    {0x20, 0x03, HID_CtrlSetupGetProtocol, 0, 0, &g_HID_sDevice},
};
...
int32_t HID_SetReportDescriptor_MS(const uint8_t* pu8ReportDescriptor, uint32_t u32ReportDescriptorSize)
{
    ...
    g_HID_sDevice.pu8ReportDescriptor_MS = pu8ReportDescriptor;
    g_HID_sDevice.u32ReportDescriptorSize_MS = u32ReportDescriptorSize;
...
int32_t HID_SetReportDescriptor_KB(const uint8_t* pu8ReportDescriptor, uint32_t u32ReportDescriptorSize)
{
    ...
    g_HID_sDevice.pu8ReportDescriptor_KB = pu8ReportDescriptor;
    g_HID_sDevice.u32ReportDescriptorSize_KB = u32ReportDescriptorSize;
...
int32_t HID_SetReportBuf_MS(uint8_t* pu8Report, uint32_t u32ReportSize)
{
    ...
    g_HID_sDevice.pu8Report_MS = pu8Report;
    g_HID_sDevice.u32ReportSize_MS = u32ReportSize;
    g_HID_sDevice.isReportReady_MS = 0;
...
int32_t HID_SetReportBuf_KB(uint8_t* pu8Report, uint32_t u32ReportSize)
{
    ...
    g_HID_sDevice.pu8Report_KB = pu8Report;
    g_HID_sDevice.u32ReportSize_KB = u32ReportSize;
    g_HID_sDevice.isReportReady_KB = 0;
...
void HID_CtrlSetupSetReport(void * pVoid)
{
    ...
    if(psDevice->au8Setup[3] == 1)
    {
        ...
        *((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(1))))=0 ? (((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(1)))))) & 0x37F) : (((*((volatile unsigned int *)((((( uint32_t)0x40000000) + 0x60000) + 0x28)+(0x10*(1)))))) | 0x80);
...
void HID_CtrlSetupDataOutReport(void * pVoid)
{
	...
	pu8EpBuf = DrvUSB_GetOutData(0x00, &size);
...
void HID_CtrlGetDescriptorIn(void * pVoid)
{
    ...
    if(gpu8UsbBuf)
    {
        ...
        {
            u32Len = Minimum(gu32BytesInUsbBuf, 8);
...
void HID_CtrlSetupGetDescriptor(void * pVoid)
{
    ...
    case 0x01:
    {
        HID_PrepareDescriptors(g_HID_sDevice.au8DeviceDescriptor, 18, u16Len, 8);
    ...
    case 0x02:
    {   
        HID_PrepareDescriptors(g_HID_sDevice.au8ConfigDescriptor, g_HID_au8ConfigDescriptor[2], u16Len, 8);
        break;
    }
        
    case 0x21:
    {
        HID_PrepareDescriptors(g_HID_sDevice.pu8HIDDescriptor, 0x09, u16Len, 8);
        break;
    }
        
    case 0x22:
    {
        if (pUsbDevice->au8Setup[4] == 0x0)      
					HID_PrepareDescriptors(g_HID_sDevice.pu8ReportDescriptor_MS, g_HID_sDevice.u32ReportDescriptorSize_MS, u16Len, 8);
				if (pUsbDevice->au8Setup[4] == 0x1)      
					HID_PrepareDescriptors(g_HID_sDevice.pu8ReportDescriptor_KB, g_HID_sDevice.u32ReportDescriptorSize_KB, u16Len, 8);
        break;
    }
    ...
    case 0x03:
    {
        ...
        {
            HID_PrepareDescriptors(g_HID_au8StringLang, 4, u16Len, 8);
        }
        else
        {
            ...
            {
            case 1:
                HID_PrepareDescriptors((const uint8_t *)g_HID_sDevice.sVendorInfo.psVendorStringDesc, g_HID_sDevice.sVendorInfo.psVendorStringDesc->byLength, u16Len, 8);
                break;

            case 2:
                HID_PrepareDescriptors((const uint8_t *)g_HID_sDevice.sVendorInfo.psProductStringDesc, g_HID_sDevice.sVendorInfo.psProductStringDesc->byLength, u16Len, 8);
               
                break;

            case 3:
                HID_PrepareDescriptors(g_HID_au8StringSerial, g_HID_au8StringSerial[0], u16Len, 8);
                break;
