#line 1 "..\\..\\..\\Src\\NUC1xx-LB_002\\DrvSDCard.c"
...
#line 11 "..\\..\\..\\Src\\NUC1xx-LB_002\\DrvSDCard.c"
...
#line 15 "..\\..\\..\\Src\\NUC1xx-LB_002\\DrvSDCard.c"
...
#line 16 "..\\..\\..\\Src\\NUC1xx-LB_002\\DrvSDCard.c"
...
#line 17 "..\\..\\..\\Src\\NUC1xx-LB_002\\DrvSDCard.c"
...
#line 18 "..\\..\\..\\Src\\NUC1xx-LB_002\\DrvSDCard.c"
...
#line 43 "..\\..\\..\\Src\\NUC1xx-LB_002\\DrvSDCard.c"
...
uint32_t MMC_Command_Exec (uint8_t nCmd, uint32_t nArg,uint8_t *pchar, uint32_t *response)
{
    ...
    {                                   
		...
		case 3:                         
	     	...
	     	while((SingleWrite(0xFF)&0xFF)!=0xFE) 
			{
    	  		if(!++loopguard) {{ SingleWrite(0xFF);DrvSPI_ClrSS(eDRVSPI_PORT1, eDRVSPI_SS0); return 0;};}
				DrvSYS_Delay(1);
	      	}		
			...
			((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->TX[0] = 0xFFFFFFFF;
			if(pchar)
			{
				...
				((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.TX_BIT_LEN=0; 	
				((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.REORDER=2;
				((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.TX_NUM=1;				
				for (; counter<current_blklen-7; )
				{

					((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.GO_BUSY = 1;
					while(((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.GO_BUSY);
					*((uint32_t*)(pchar+counter))=((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->RX[0];
					counter+=4;
					*((uint32_t*)(pchar+counter))=((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->RX[1];
					counter+=4;				
				}
				((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.TX_NUM=0;
				((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.REORDER=0;
				((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL.TX_BIT_LEN=8;
		...
		case 2: 			
	        ...
	        while((SingleWrite(0xFF)&0xFF)!=0xFF);
			SingleWrite(0xFF);	        
	        break;
		default: break;
	}
...
void SpiRead(uint32_t addr, uint32_t size, uint8_t* buffer)
{
	...
	if(SDtype&1<<4)
	{
		...
		while(size >= 512)
		{
			while(MMC_Command_Exec(8,addr,buffer,&response)==0);
			addr   ++;
			buffer += 512;
			size  -= 512;
		}
...
void SpiWrite(uint32_t addr, uint32_t size, uint8_t* buffer)
{
	...
	if(SDtype&1<<4)
	{
		while(size >= 512)
		{
			while(MMC_Command_Exec(11,addr,buffer,&response)==0);
			addr   ++;
			buffer += 512;
			size  -= 512;
		}
