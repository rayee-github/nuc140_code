...
{
	DSTATUS sta;
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->PMD.PMD12=1;
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->DOUT&=0xEFFF;

	while((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->PIN&0x2000)!=0);
	RoughDelay(100000);
	if(DrvSDCARD_Open() == 0)
	{	
	sta = 	RES_OK;
